public class test1 {
	public static void main(String[] args) {
		...
		int numb = 1 ;
		String result = numb>=1 ? "positive" : numb<=-1 ? "negative" : "zero";
...
int nume = 4;
int numf = -3;
String results = (nume>=0 && numf>=0) ? "both positive" : (nume<0 && numf<0) ?  "both negative" : (nume>0 || numf>0) ?  "one positive" : "etc" ;
